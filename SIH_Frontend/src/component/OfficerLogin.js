    ...
    return (
     ...
     <section className="text-gray-500 body-font ">
       <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
         ...
         <div className=''>
           <h2 className="text-gray-900 text-2xl text-center font-medium title-font">Login for District/State/Ministry Officials</h2>
          ...
          <div className="mb-4">
           ...
           <div className="mb-4">
             <label htmlFor="full-name" className="tracking-wide leading-7 text-sm text-gray-500">Username</label>
